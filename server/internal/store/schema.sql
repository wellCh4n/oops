-- The schema, in the shape sqlc generates against. internal/store/migrations
-- builds the same thing in the database; a test checks the two have not drifted.
--
...
CREATE TABLE `application_runtime_spec` (
    `id` varchar(255) NOT NULL,
    `created_time` datetime(6) DEFAULT NULL,
    `application_name` varchar(255) NOT NULL DEFAULT '',
    `environment_configs` text NOT NULL,
