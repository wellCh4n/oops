    ...
    <DocLayout title="流水线">
      ...
      <DocSection title="列出流水线">
        ...
        <DocSubSection title="响应分页元素 (PipelineDto)">
          ...
          />
          <DocParagraph>
            <InlineCode>status</InlineCode> 取值：<InlineCode>RUNNING</InlineCode>、<InlineCode>BUILD_SUCCEEDED</InlineCode>、<InlineCode>DEPLOYING</InlineCode>、<InlineCode>VERIFYING</InlineCode>、<InlineCode>SUCCEEDED</InlineCode>、<InlineCode>FAILED</InlineCode>、<InlineCode>STOPPED</InlineCode>。
          </DocParagraph>
        </DocSubSection>
      </DocSection>
