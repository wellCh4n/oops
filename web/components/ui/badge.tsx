  ...
  "group/badge inline-flex h-5 w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-full border border-transparent px-2 py-0.5 text-xs font-medium whitespace-nowrap transition-all focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&>svg]:pointer-events-none [&>svg]:size-3!",
  {
    variants: {
      variant: {
        ...
        // Semantic variants restored to their pre-migration tinted-with-border look.
        destructive:
        ...
        warning:
          "border-warning/25 bg-warning/15 text-warning focus-visible:ring-warning/20 dark:focus-visible:ring-warning/40 [a&]:hover:bg-warning/25",
        success:
          "border-success/25 bg-success/15 text-success focus-visible:ring-success/20 dark:focus-visible:ring-success/40 [a&]:hover:bg-success/25",
        info:
          "border-primary/25 bg-primary/15 text-primary focus-visible:ring-primary/20 dark:focus-visible:ring-primary/40 [a&]:hover:bg-primary/25",
        outline:
