const ide = {
  ...
  "ide.zipUnsupported": "IDEs are only available for Git source applications",
  "ide.zipUnsupportedDesc": "This application's source is not a Git repository, so there is no code to open in an IDE.",
